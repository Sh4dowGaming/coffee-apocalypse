...
class Building
{
	constructor(name, productivity, price)
	{
		...
		this.area.append(document.createTextNode("Coffee per Second: "));
		this.area.append(this.productivity_display);
		this.area.append(document.createElement("br"));

		this.area.append(document.createTextNode("Uupgrade Price: "));
...
clicker = new Clicker();
baker = new Building("Coffee Plantation", 1, 20);
baker.set_visible();
bakery = new Building("Coffee Machine", 10, 200);
factory = new Building("Factory", 100, 2000);
cookie_tesla = new Building("Coffee Mine", 1000, 20000);
cookie_gigant = new Building("Coffee Bank", 10000, 200000);
